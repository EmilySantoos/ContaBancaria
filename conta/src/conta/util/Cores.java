...
public class Cores {
	...
	//Text Color para a tela de fundo
	...
	//Text Color Bold cor em negrito para os textos
	...
	//Reset Text Underline cor para textos
	...
	// Text Color High Intensity cor clara para textos
	...
	// Text Color Bold High Intensity(cor mais clara) e a propriedade negrito (bold) para os textos
	...
	// Background Color High Intensity 8 cores básicas,(cor mais clara para o funda da tela)
